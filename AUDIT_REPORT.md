...
This is a historical audit, not a statement of the current deployment. ESP32 now uses its provisioned device account rather than anonymous authentication. Refer to the current schema and source code for the active implementation.
